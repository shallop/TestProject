 ...
 */
public class MyLayoutManager extends RecyclerView.LayoutManager implements
     ...
     */
    public MyLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                               int defStyleRes) {
...
//            }
    ...
    private int computeScrollOffset(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return MyScrollbarHelper.computeScrollOffset(state, mOrientationHelper,
    ...
    private int computeScrollExtent(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return MyScrollbarHelper.computeScrollExtent(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
    ...
    private int computeScrollRange(RecyclerView.State state) {
        ...
        ensureLayoutState();
        return MyScrollbarHelper.computeScrollRange(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
                this, mSmoothScrollbarEnabled);
    }
