 ...
 */
public class CardLayoutManager1 extends RecyclerView.LayoutManager implements
     ...
     */
    public CardLayoutManager1(Context context) {
     ...
     */
    public CardLayoutManager1(Context context, int orientation, boolean reverseLayout) {
...
//        setAutoMeasureEnabled(true);
     ...
     */
    public CardLayoutManager1(Context context, AttributeSet attrs, int defStyleAttr,
                              int defStyleRes) {
...
//    }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        Log.d(TAG, "onLayoutChildren: onlayoutChild");
    }
